      ...
      <CardContent>
        ...
        <div className="flex justify-around mb-6 text-sm">
            ...
            <div className="text-center">
                ...
                <p className={`text-lg font-medium ${totals.income - totals.expense > 0 ? "text-green-500" : "text-red-500" }`}> ₹{(totals.income - totals.expense).toFixed(2)} </p>
            </div>
        </div>
        ...
        <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
                ...
                >
                <CartesianGrid strokeDasharray="3 3" vartical={false} />
                <XAxis dataKey="date" />
                <YAxis 
                    fontSize={12}
                    tickLine={false}
